...
describe('GROQ Queries', () => {
  it('should have valid home page query', () => {
    ...
    expect(queryHomePageData).toContain('*[_type == "homePage" && _id == "homePage"][0]')
  ...
  it('should have valid slug page query with parameter', () => {
    ...
    expect(querySlugPageData).toContain('*[_type == "page" && slug.current == $slug][0]')
  ...
  it('should have valid blog slug query with parameter', () => {
    ...
    expect(queryBlogSlugPageData).toContain('*[_type == "blog" && slug.current == $slug][0]')
  ...
  it('should have valid path queries', () => {
    expect(queryBlogPaths).toContain('*[_type == "blog" && defined(slug.current)].slug.current')
    expect(querySlugPagePaths).toContain('*[_type == "page" && defined(slug.current)].slug.current')
  })
