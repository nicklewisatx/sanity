...
export type TechnologyShowcase = {
...
export type Technology = {
  ...
  homepage?: string;
  buzzRating?: "bummer" | "meh" | "good" | "exciting" | "fire";
  seoTitle?: string;
  seoDescription?: string;
  seoImage?: {
    asset?: {
...
// Variable: queryTechnologiesData
// Query: *[_type == "technology"] | order(buzzRating desc, title asc) {      _id,  _type,  title,  slug,  tags,  description[]{    ...,      markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }  },  logo{    ...,    ...asset->{      "alt": coalesce(alt, altText, originalFilename, "no-alt"),      "blurData": metadata.lqip,      "dominantColor": metadata.palette.dominant.background    },  },  homepage,  buzzRating  }
export type QueryTechnologiesDataResult = Array<{
  _id: string;
  _type: "technology";
  title: string;
  slug: Slug;
  ...
  buzzRating: "bummer" | "exciting" | "fire" | "good" | "meh" | null;
}>;
// Variable: queryTechnologyBySlug
// Query: *[_type == "technology" && slug.current == $slug][0]{      _id,  _type,  title,  slug,  tags,  description[]{    ...,      markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }  },  logo{    ...,    ...asset->{      "alt": coalesce(alt, altText, originalFilename, "no-alt"),      "blurData": metadata.lqip,      "dominantColor": metadata.palette.dominant.background    },  },  homepage,  buzzRating  }
export type QueryTechnologyBySlugResult = {
  _id: string;
  _type: "technology";
  title: string;
  slug: Slug;
...
// Variable: queryResourcesData
// Query: *[_type == "resource"] | order(date desc) {      _id,  _type,  title,  slug,  link,  description[]{    ...,      markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }  },  date,  tags,  "technology": technology->{      _id,  _type,  title,  slug,  tags,  description[]{    ...,      markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }  },  logo{    ...,    ...asset->{      "alt": coalesce(alt, altText, originalFilename, "no-alt"),      "blurData": metadata.lqip,      "dominantColor": metadata.palette.dominant.background    },  },  homepage,  buzzRating  }  }
export type QueryResourcesDataResult = Array<{
  _id: string;
  _type: "resource";
  title: string;
  slug: Slug;
...
// Variable: queryResourcesByTechnology
// Query: *[_type == "resource" && technology._ref == $technologyId] | order(date desc) {      _id,  _type,  title,  slug,  link,  description[]{    ...,      markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }  },  date,  tags,  "technology": technology->{      _id,  _type,  title,  slug,  tags,  description[]{    ...,      markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      "#"    ),  }  }  },  logo{    ...,    ...asset->{      "alt": coalesce(alt, altText, originalFilename, "no-alt"),      "blurData": metadata.lqip,      "dominantColor": metadata.palette.dominant.background    },  },  homepage,  buzzRating  }  }
export type QueryResourcesByTechnologyResult = Array<{
  _id: string;
  _type: "resource";
  title: string;
  slug: Slug;
