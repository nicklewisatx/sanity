              ...
              <li className="row-span-3">
                <NavigationMenuLink asChild>
                  ...
                  >
                    ...
                    <p className="text-sm leading-tight text-muted-foreground">
                      Check out our latest product features and improvements.
                    </p>
                  </a>
                </NavigationMenuLink>
              </li>
        ...
        <NavigationMenuItem>
          ...
          <NavigationMenuContent>
            <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2">
              ...
              <ListItem href="/startups" title="Startups">
                Get started quickly with our startup package.
              </ListItem>
              <ListItem href="/agencies" title="Agencies">
                Tools designed for creative agencies.
              </ListItem>
        ...
        <NavigationMenuItem>
          ...
          <NavigationMenuContent>
            <ul className="grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-2">
              <ListItem href="/features/dashboard" title="Dashboard">
                Comprehensive overview of your data at a glance.
              </ListItem>
              ...
              <ListItem href="/features/api" title="API Access">
