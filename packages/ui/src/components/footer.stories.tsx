...
export const Default: Story = {
  args: {
    ...
    description: "Building the future of web applications with modern tools and best practices.",
...
export const WithBrandOnly: Story = {
  args: {
    ...
    description: "We create beautiful digital experiences that people love. Join us on our journey to make the web a better place.",
    socialLinks: socialLinks,
...
export const Large: Story = {
  args: {
    ...
    description: "Enterprise-grade solutions for modern businesses. Trusted by thousands of companies worldwide.",
    sections: defaultSections,
    socialLinks: socialLinks,
